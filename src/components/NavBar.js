  ...
  return (
    ...
    <div className="w-full flex justify-between items-center lg:hidden">
      <nav>
        ...
        {/* <CustomLink href="/login" title="LogIn" className="mx-4" /> */}
        {/* <CustomLink href="/articles" title="Articles" className="ml-4" /> */}
      </nav>
      
      <nav className="flex items-center justify-center flex-wrap">
        <motion.a
          href="https://twitter.com/thekushmevada"
          target={"_blank"}
          className="w-7 mr-3"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          href="https://github.com/thekushmevada"
          target={"_blank"}
          className="w-7 mx-3"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          href="https://www.linkedin.com/in/thekushmevada/"
          target={"_blank"}
          className="w-7 mx-3"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
    ...
    <div className="absolute left-1/2 top-2 translate-x-[50%] lg:hidden ">
        <Logo />
      </div>
